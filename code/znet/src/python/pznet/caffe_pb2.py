...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='affinitize_param', full_name='caffe.LayerParameter.affinitize_param', index=62,
...
_AFFINITIZEPARAMETER = _descriptor.Descriptor(
  name='AffinitizeParameter',
  full_name='caffe.AffinitizeParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='axis', full_name='caffe.AffinitizeParameter.axis', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='dst', full_name='caffe.AffinitizeParameter.dst', index=1,
...
_LAYERPARAMETER.fields_by_name['affinitize_param'].message_type = _AFFINITIZEPARAMETER
...
DESCRIPTOR.message_types_by_name['AffinitizeParameter'] = _AFFINITIZEPARAMETER
...
AffinitizeParameter = _reflection.GeneratedProtocolMessageType('AffinitizeParameter', (_message.Message,), dict(
  DESCRIPTOR = _AFFINITIZEPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.AffinitizeParameter)
  ))
_sym_db.RegisterMessage(AffinitizeParameter)
