...
struct fwd_parallel_schedule2_t
{
    ...
    static const long_t tpart = Problem::threads / 2;

    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next, Factor*2>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next, Factor*2>::schedule(n+tpart,e);
...
struct fwd_parallel_schedule3_t
{
    ...
    static const long_t tpart = Problem::threads / 3;

    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next, Factor*3>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next, Factor*3>::schedule(n+tpart,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next, Factor*3>::schedule(n+tpart+tpart,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
...
struct fwd_parallel_schedule5_t
{
    ...
    static const long_t tpart = Problem::threads / 5;

    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next, Factor*5>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next, Factor*5>::schedule(n+tpart,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next, Factor*5>::schedule(n+tpart*2,e);
        fwd_schedule2_t<typename split::template part<3>::type, Next, Factor*5>::schedule(n+tpart*3,e);
        fwd_schedule2_t<typename split::template part<4>::type, Next, Factor*5>::schedule(n+tpart*4,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
...
struct fwd_parallel_schedule7_t
{
    ...
    static const long_t tpart = Problem::threads / 7;

    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next, Factor*7>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next, Factor*7>::schedule(n+tpart,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next, Factor*7>::schedule(n+tpart*2,e);
        fwd_schedule2_t<typename split::template part<3>::type, Next, Factor*7>::schedule(n+tpart*3,e);
        fwd_schedule2_t<typename split::template part<4>::type, Next, Factor*7>::schedule(n+tpart*4,e);
        fwd_schedule2_t<typename split::template part<5>::type, Next, Factor*7>::schedule(n+tpart*5,e);
        fwd_schedule2_t<typename split::template part<6>::type, Next, Factor*7>::schedule(n+tpart*6,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
