...
do_plot('vgg', 'upd', 'skylake', 128)
do_plot('vgg', 'fwd', 'skylake', 128)

do_plot('vgg', 'upd', 'haswell', 2.5*32)
do_plot('vgg', 'fwd', 'haswell', 2.5*32)

do_plot('vgg', 'upd', 'knl', 1.1*64)
do_plot('vgg', 'fwd', 'knl', 1.1*64)


do_plot('unet', 'upd', 'skylake', 128)
do_plot('unet', 'fwd', 'skylake', 128)

do_plot('unet', 'upd', 'haswell', 2.5*32)
do_plot('unet', 'fwd', 'haswell', 2.5*32)

do_plot('unet', 'upd', 'knl', 1.1*64)
do_plot('unet', 'fwd', 'knl', 1.1*64)

do_plot('d3d', 'upd', 'skylake', 128)
do_plot('d3d', 'fwd', 'skylake', 128)
