...
znn::phi::Znet::Znet(std::string weights_path)
{
	...
	layers["pool_d2"] = new znn::phi::MaxPoolingLayer(1, 36, 18, 96, 96, 1, 2, 1);
	layers["pool_d3"] = new znn::phi::MaxPoolingLayer(1, 48, 18, 48, 48, 1, 2, 1);
	layers["pool_d1"] = new znn::phi::MaxPoolingLayer(1, 28, 18, 192, 192, 1, 2, 1);
	layers["pool_d4"] = new znn::phi::MaxPoolingLayer(1, 64, 18, 24, 24, 1, 2, 1);
	layers["pool_d5"] = new znn::phi::MaxPoolingLayer(1, 80, 18, 12, 12, 1, 2, 1);
