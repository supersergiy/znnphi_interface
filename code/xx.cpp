#include "znn/bench/propagation_full_image.hpp"
#include "znn/bench/propagation_sub_layer.hpp"
...
int main()
{
    ...
    // benchmark_propagation_sub_layer<1, 1, 1, 52, 52, 1, 11, 11, 1, 4, 4>(20000);
    // benchmark_propagation_full_image<false, 1, 52, 52, 1, 11, 11, 1, 4, 4>(20000);
    // benchmark_propagation_full_image<true, 1, 112, 112, 1, 3, 3, 1, 1, 1>(2000);
    benchmark_propagation_sub_layer<1, 1, 1, 568, 568, 1, 3, 3, 1, 1, 1>(2000);
