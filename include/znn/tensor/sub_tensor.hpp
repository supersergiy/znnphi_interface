...
class const_sub_tensor : public value_accessor<T, D, A>
{
private:
...
public:
    ...
    long_t const* shape() const { return extents_; }
...
template <class T, size_t D, class A>
class sub_tensor : public const_sub_tensor<T, D, A>
{
private:
...
public:
    ...
    reference operator[](long_t i) noexcept
    {
        return super_type::access(znn::phi::type_t<reference>(), i,
                                  super_type::ptr_, super_type::extents_,
                                  super_type::strides_);
    }

    T const* data() const { return super_type::ptr_; }

    T* data() { return super_type::ptr_; }
    ...
    {
        detail::tensor::copy_n(d, this->num_elements(), super_type::ptr_, tag,
                               architecture());
    }
    ...
    void load_n(T const* d, size_t n, DevTag const& tag)
    {
        ...
        detail::tensor::copy_n(d, n, super_type::ptr_, tag, architecture());
    }
