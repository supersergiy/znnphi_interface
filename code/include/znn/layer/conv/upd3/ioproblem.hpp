...
template< long_t T, long_t I, long_t O,
          class Strides,
          long_t IOff = 0, long_t OOff = 0, long_t KOff = 0 >
...
template< long_t IStride, long_t OStride,
          long_t KIStride, long_t KOStride >
...
struct upd_io_problem_cat< upd_io_problems_t<As...>,
                             upd_io_problems_t<Bs...>, Cs... >
{
    using type = typename
        upd_io_problem_cat< upd_io_problems_t<As...,Bs...>, Cs... >::type;
};
...
struct upd_io_problems_printer< upd_io_problems_t<As...> >
{
    static void print()
    {
        upd_io_problems_printer_h<As...>::print();
    }
};
...
struct upd_io_problem_split_i
{
    ...
    struct get
    {
        using type = upd_io_problem_t<
            P::threads / N, P::i / N, P::o,
            typename P::strides,
            P::ioff + P::strides::istride * (P::i/N) * K,
            P::ooff,
...
{
    using type = upd_io_problem_cat_t<
        typename upd_io_split_problem<
...
{
    using type = typename
        upd_io_recursive_split_h<C, std::make_integer_sequence<long_t,
                                                               C::parts>>::type;
};
...
public:
    ...
    using type = typename conditional_t<
        condition_t< prime == 1 >,
        type_wrapper_t< upd_io_problems_t<P> >,
