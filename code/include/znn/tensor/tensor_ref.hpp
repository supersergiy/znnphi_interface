...
public:
    ...
    {
        return super_type::access(znn::phi::type_t<const_reference>(), i,
                                  ptr_,
                                  extents_.data(),
                                  strides_.data());
    }
...
template<class T, size_t D>
using hbw_const_tensor_ref =
    const_tensor_ref<T,D,detail::tensor::hbw_tag>;
...
template<class T>
using hbw_const_array_ref =
    const_tensor_ref<T,1,detail::tensor::hbw_tag>;
