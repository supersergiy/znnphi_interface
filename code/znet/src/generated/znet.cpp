...
znn::phi::Znet::Znet(std::string weights_path)
{
	...
	layers["conv5_d0"] = new znn::phi::ConvWrapper(1, 28, 28, 18, 194, 1, 3, 0, 1, true, false, 2, 2);
	...
	layers["convf6_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 18, 50, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf6_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 18, 14, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf5_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 18, 14, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf5_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 18, 26, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf5_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 18, 50, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf6_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 18, 26, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["conv5_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 20, 48, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv5_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 20, 24, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv5_d1"] = new znn::phi::ConvWrapper(1, 36, 36, 18, 98, 1, 3, 0, 1, true, false, 2, 2);
	...
	layers["conv5_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 20, 12, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 20, 12, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d5"] = new znn::phi::ConvWrapper(1, 96, 96, 20, 6, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 20, 48, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 20, 24, 3, 1, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d0"] = new znn::phi::ConvWrapper(1, 28, 28, 18, 194, 1, 3, 0, 1, true, false, 2, 2);
	...
	layers["conv1_d1"] = new znn::phi::ConvWrapper(1, 36, 36, 18, 98, 1, 3, 0, 1, true, false, 2, 2);
	...
	layers["convi"] = new znn::phi::ConvWrapper(1, 1, 28, 18, 196, 1, 5, 0, 1, true, false, 2, 2);
	...
	layers["conv7_d0"] = new znn::phi::ConvWrapper(1, 28, 28, 18, 194, 1, 3, 0, 2, true, false, 2, 2);
	...
	layers["convf1_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 18, 26, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf1_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 18, 50, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf1_d5"] = new znn::phi::ConvWrapper(1, 96, 96, 18, 8, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf1_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 18, 14, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf2_d4"] = new znn::phi::ConvWrapper(1, 80, 80, 18, 14, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf2_d5"] = new znn::phi::ConvWrapper(1, 96, 96, 18, 8, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf2_d2"] = new znn::phi::ConvWrapper(1, 48, 48, 18, 50, 1, 3, 1, 0, false, false, 2, 2);
	...
	layers["convf2_d3"] = new znn::phi::ConvWrapper(1, 64, 64, 18, 26, 1, 3, 1, 0, false, false, 2, 2);
