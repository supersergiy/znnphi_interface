...
void znn::phi::Znet::forward(void)
{
	...
	for (int i = 0; i < 1; i++) {
		...
		layers["conv2_d2"]->forward(tensors["convf2_d2_padded"]->data(), tensors["conv0_d2"]->data(), tensors["conv2_d2_kernel"]->data(), tensors["conv2_d2_bias"]->data(), tensors["conv2_d2_scale"]->data());
		...
		layers["conv2_d3"]->forward(tensors["convf2_d3_padded"]->data(), tensors["conv0_d3"]->data(), tensors["conv2_d3_kernel"]->data(), tensors["conv2_d3_bias"]->data(), tensors["conv2_d3_scale"]->data());
		...
		layers["conv2_d4"]->forward(tensors["convf2_d4_padded"]->data(), tensors["conv0_d4"]->data(), tensors["conv2_d4_kernel"]->data(), tensors["conv2_d4_bias"]->data(), tensors["conv2_d4_scale"]->data());
		...
		layers["conv2_d5"]->forward(tensors["convf2_d5_padded"]->data(), tensors["conv0_d5"]->data(), tensors["conv2_d5_kernel"]->data(), tensors["conv2_d5_bias"]->data(), tensors["conv2_d5_scale"]->data());
		...
		layers["conv6_d4"]->forward(tensors["convf6_d4_padded"]->data(), tensors["conv4_d4"]->data(), tensors["conv6_d4_kernel"]->data(), tensors["conv6_d4_bias"]->data(), tensors["conv6_d4_scale"]->data());
		...
		layers["conv6_d3"]->forward(tensors["convf6_d3_padded"]->data(), tensors["conv4_d3"]->data(), tensors["conv6_d3_kernel"]->data(), tensors["conv6_d3_bias"]->data(), tensors["conv6_d3_scale"]->data());
		...
		layers["conv6_d2"]->forward(tensors["convf6_d2_padded"]->data(), tensors["conv4_d2"]->data(), tensors["conv6_d2_kernel"]->data(), tensors["conv6_d2_bias"]->data(), tensors["conv6_d2_scale"]->data());
		...
		layers["conv6_d1"]->forward(tensors["conv5_d1_padded"]->data(), tensors["conv4_d1"]->data(), tensors["conv6_d1_kernel"]->data(), tensors["conv6_d1_bias"]->data(), tensors["conv6_d1_scale"]->data());
		...
		layers["conv6_d0"]->forward(tensors["conv5_d0_padded"]->data(), tensors["conv4_d0"]->data(), tensors["conv6_d0_kernel"]->data(), tensors["conv6_d0_bias"]->data(), tensors["conv6_d0_scale"]->data());
