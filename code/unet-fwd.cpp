...
int main()
{
    ...
    // benchmark_forward<1,64,128,1,284,1,3>("conv2a");
    // benchmark_forward<1,128,128,1,282,1,3>("conv2b");

    // benchmark_forward<1,128,256,1,140,1,3>("conv3a");
    // benchmark_forward<1,256,256,1,138,1,3>("conv3b");

    // benchmark_forward<1,256,512,1,68,1,3>("conv4a");
    benchmark_forward<1,512,512,1,66,1,3>("conv4b");

    benchmark_forward<1,512,1024,1,32,1,3>("conv5a");
