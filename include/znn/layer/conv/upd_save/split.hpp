...
struct upd_depth_split_t
{
    using first = upd_problem_t
        < upd_problem_size_t< Problem::size::depth / 2,
                              Problem::size::height,
                              Problem::size::width >,
...
template<>
class upd_depth_split_t< null_upd_problem_t >
{
...
struct upd_height_split_t
{
    ...
    using second = upd_problem_t
        < upd_problem_size_t< Problem::size::depth,
          ...
          typename Problem::ishape,
          typename Problem::oshape,
          Problem::ioffset + (Problem::size::height/2) * Problem::ishape::height,
          Problem::ooffset + (Problem::size::height/2) * Problem::oshape::height >;

};

template<>
class upd_height_split_t< null_upd_problem_t >
{
    using first  = null_upd_problem_t;
    using second = null_upd_problem_t;
};
...
template<>
struct upd_width_split_t< null_upd_problem_t >
{
    using first  = null_upd_problem_t;
    using second = null_upd_problem_t;
};
...
struct upd_split_problem_t
{
    using type = typename conditional_t<
        condition_t< (Problem::size::width>128) >,
        upd_width_split_t< Problem >,
        condition_t< (Problem::size::depth>3) && ((Problem::size::depth%2)==0) >,
        upd_depth_split_t< Problem >,
        condition_t< (Problem::size::height>3) && ((Problem::size::height%2)==0) >,
        upd_height_split_t< Problem >,
        condition_t< (Problem::size::depth>3) >,
        upd_depth_split_t< Problem >,
        condition_t< (Problem::size::height>3) >,
        upd_height_split_t< Problem >,
        condition_t< (Problem::size::width>3) >,
        upd_width_split_t< Problem >,
        upd_nosplit_t< Problem > >::type;
};
...
template< long_t N, class Problem >
struct upd_divide_problem_t
{
    ...
    using type = typename upd_problems_cat_t<
        ...
        typename upd_divide_problem_t<N/2, typename split::second>::type >::type;

};

template< class Problem >
struct upd_divide_problem_t<1,Problem>
{
