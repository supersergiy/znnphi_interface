...
{
private:
    static constexpr prime = smallest_prime_factor(Problem::threads);
...
template< long_t Threads,
          class Batch,
          class OF, class IF,
          class D , class H , class W ,
          class KN, class KD, class KH, class KW >
class upd_plan
{
private:
