...
#include "znn/layer/conv/fwd/split_n.hpp"
#include "znn/layer/conv/fwd/execute.hpp"
...
struct fwd_parallel_schedule2_t
{
    ...
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next*2, Factor*2>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next*2, Factor*2>::schedule(n+Next,e);
...
struct fwd_parallel_schedule3_t
{
    ...
    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next*3, Factor*3>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next*3, Factor*3>::schedule(n+Next,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next*3, Factor*3>::schedule(n+Next+Next,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
...
struct fwd_parallel_schedule5_t
{
    ...
    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next*5, Factor*5>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next*5, Factor*5>::schedule(n+Next,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next*5, Factor*5>::schedule(n+Next*2,e);
        fwd_schedule2_t<typename split::template part<3>::type, Next*5, Factor*5>::schedule(n+Next*3,e);
        fwd_schedule2_t<typename split::template part<4>::type, Next*5, Factor*5>::schedule(n+Next*4,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
...
struct fwd_parallel_schedule7_t
{
    ...
    static void schedule( long_t n, exec_vector & e )
    {
        fwd_schedule2_t<typename split::template part<0>::type, Next*7, Factor*7>::schedule(n,e);
        fwd_schedule2_t<typename split::template part<1>::type, Next*7, Factor*7>::schedule(n+Next,e);
        fwd_schedule2_t<typename split::template part<2>::type, Next*7, Factor*7>::schedule(n+Next*2,e);
        fwd_schedule2_t<typename split::template part<3>::type, Next*7, Factor*7>::schedule(n+Next*3,e);
        fwd_schedule2_t<typename split::template part<4>::type, Next*7, Factor*7>::schedule(n+Next*4,e);
        fwd_schedule2_t<typename split::template part<5>::type, Next*7, Factor*7>::schedule(n+Next*5,e);
        fwd_schedule2_t<typename split::template part<6>::type, Next*7, Factor*7>::schedule(n+Next*6,e);
        fwd_schedule2_t<typename split::rest, Next, Factor*2>::schedule(n,e);
    }
};
