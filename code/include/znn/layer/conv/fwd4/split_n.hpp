...
public:
    ...
    struct part
    {
        using type = typename std::conditional<(K<drest),
            fwd_problem_t<
            Problem::threads / N,
            part_size,
...
public:
    ...
    struct part
    {
        using type = typename std::conditional<(K<hrest),
            fwd_problem_t<
            Problem::threads / N,
            part_size,
...
public:
    ...
    struct part
    {
        using type = typename std::conditional<(K<wrest),
            fwd_problem_t<
            Problem::threads / N,
            part_size,
...
struct fwd_splitn_problem_t
{
    ...
    // fwd_depth_splitn_t< Problem, N >,
        ...
        // fwd_height_splitn_t< Problem, N >,
        // condition_t< (Problem::threads>32)&&(Problem::size::height > Problem::size::width) >,
        // fwd_height_splitn_t< Problem, N >,
