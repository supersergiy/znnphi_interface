...
private:
    ...
    using offsets = typename Problem::offsets;
public:
    ...
    struct part
    {
        using type = fwd_problem_t<
            ...
            Problem::koffset,
            Problem::boffset,
            fwd_offset_t<offsets::d_from + (size::depth/N)*K,
                         offsets::d_from + (size::depth/N)*K*2,
                         offsets::h_from, offsets::h_to>,
            shapes >;
    };
    ...
    using rest = typename std::conditional<
        ...
        fwd_problem_t<
            ...
            Problem::koffset,
            Problem::boffset,
            fwd_offset_t<offsets::d_from + (size::depth/N)*N,
                         offsets::d_to,
                         offsets::h_from, offsets::h_to>,
            shapes > >::type;
};
...
public:
    ...
    struct part
    {
        using type = fwd_problem_t<
            ...
            Problem::koffset,
            Problem::boffset,
            fwd_offset_t<offsets::d_from, offsets::d_to,
                         offsets::h_from + (size::depth/N)*K,
                         offsets::h_from + (size::depth/N)*K*2>,
            shapes >;
    };
