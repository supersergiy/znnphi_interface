...
{
	tensors["user_output"] = new znn::phi::hbw_array<float>(4718592);
	tensors["input"] = new znn::phi::hbw_array<float>(5308416);
	tensors["user_input"] = new znn::phi::hbw_array<float>(5308416);
	tensors["output"] = new znn::phi::hbw_array<float>(4718592);
	
	tensors["conv_kernel"] = new znn::phi::hbw_array<float>(192);
	tensors["conv_bias"] = new znn::phi::hbw_array<float>(8);
	...
	layers["unblock_output"] = new znn::phi::UnblockDataLayer(1, 8, 16, 192);
	layers["conv"] = new znn::phi::ConvWrapper(1, 8, 8, 18, 192, 3, 1, 0, 0);
	
	input_size = 5308416;
	out_dim = 5;
	size_t tmp_shape[] = { 1, 8, 16, 192, 192 };
	out_shape.assign(tmp_shape, tmp_shape + 5);
	size_t tmp_strides[] = { 18874368, 2359296, 147456, 768, 4 };
