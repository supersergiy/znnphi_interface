...
VERSIONFILE = os.path.join(PACKAGE_DIR, "python/pznet/__version__.py")
...
setup(
    ...
    packages=find_packages(exclude=['tests', 'bin', 'docker']),
    url='https://github.com/seung-lab/pznet',
...
for file_name in os.listdir():
    if file_name.startswith("libpznet") and file_name.endswith(".so"):
        dst_file_name = os.path.join('python/pznet/', file_name)
