...
public:
    ...
    using second = fwd_problem_t<
        ...
        Problem::boffset + size::ofm_sets / 2,
        shapes >;
    ...
    using rest = typename std::conditional<
        ...
        fwd_problem_t<
            ...
            Problem::boffset + size::ofm_sets - 1,
            shapes > >::type;
};


template< class Problem >
struct fwd_depth_split2_t
{
private:
...
template< class Problem >
struct fwd_split2_problem_t
{
    using type = typename conditional_t<
        condition_t< (Problem::size::depth>32) >,
        fwd_depth_split2_t< Problem >,
        condition_t< (Problem::size::height>32) >,
        fwd_height_split2_t< Problem >,
        condition_t< (Problem::size::width>32) >,
        fwd_width_split2_t< Problem >,
        condition_t< (Problem::size::batch>1) >,
        fwd_batch_split2_t< Problem >,
        condition_t< (Problem::size::ofm_sets>1) >,
        fwd_ofm_split2_t< Problem >,
